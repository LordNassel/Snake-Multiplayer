...
wall *wall2;
  ...
  if(users==1){
            ...
            SDL_Texture *picD= IMG_LoadTexture(renderer, "wallpaper2.png");
            if (picD == NULL) {
            ...
            SDL_TimerID id = SDL_AddTimer(1000, idozit, NULL);
                ...
                if(collosion_detection_wall(snake_one, wall2)==true){
                ...
                if(collosion_detection_food(lunch,snake_one)==true){
                    ...
                    //Generating Food
                    lunch = make_food(lunch, wall2, snake_one);
                    //Setting Food
                    show_food(lunch);
                }
    ...
    if(users==2){
            ...
            srand((unsigned) time(&t));
            //Generating Food
            lunch = make_food_for2(lunch, wall2, snake_one,snake_two);
            //Setting Food
            show_food(lunch);
            ...
            SDL_TimerID id = SDL_AddTimer(1000, idozit, NULL);
                ...
                if(collosion_detection_wall(snake_two, wall2)==true){
                        multi_player_scoretofile(snake_one, snake_two);
                        quit = true;
                        break;
                }
